//This code just hides one picture into another.
//You can tell that it is hidden into another by the 
//loss of resolution of the last picture
...
print(hPixel.getRed());
*/
print(combine(chop2Hide(start), shift(hide)));
